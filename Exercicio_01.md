...
Leitura do codigo
placas e o array fixo que armazena cada placa.
topo guarda o indice do ultimo carro; -1 representa pilha vazia.
O construtor cria o array na capacidade informada e inicializa o topo.
estacionar testa se o array chegou ao limite; se houver vaga, incrementa topo e grava a placa.
sair verifica vazio, guarda a placa do topo, limpa a celula e decrementa o topo.
estaVazia e estaCheia verificam os dois limites da pilha.
exibir mostra os carros e usa placasDisponiveis para copiar somente as posicoes ocupadas.
placasDisponiveis percorre de zero ate topo; o indice e a variavel de controle do laço.
main cria um estacionamento de tres vagas, insere tres carros e demonstra a retirada do ultimo.
